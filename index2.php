...
<body>
    ...
    <nav class="hola">
        ...
        <!-- Cmabiar de direccion de cerrar sesion -->
        <a href="cerrar_sesion.php" class="close-session" >Cerrar sesion</a>
    </nav>
    ...
    <section id="conferencias" class="content">
        ...
        <div class="service">
            ...
            <div class="service-text">
                ...
                <br>
                <button class="boton" onclick="window.location.href='./fConferencias/conferencias.html';">Más Informes</button>
            </div>
        </div>
    </section>
